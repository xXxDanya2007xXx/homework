...
# Ответы на вопросы
print("\nОтветы на вопросы:")
print("- Ошибка становится меньше 1% "
      "примерно начиная с 10 000–100 000 симуляций.")
print('- Маленькая выборка (10–100) даёт "странные" проценты, '
      'потому что случайность сильнее влияет на результат.')
print("- При больших размерах выборки (1000 и больше) "
      "результат стабилизируется  около теоретического 33.3%.")
